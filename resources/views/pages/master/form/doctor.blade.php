    ...
    @component('common-components.breadcrumb')
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">@lang('doctor.form_title')</h4>
                        <p class="card-title-desc">@lang('doctor.form_subtitle')</p>

                        <form class="custom-validation"
                            action="{{ isset($id) ? route('doctor.update', $id) : route('doctor.store') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-12">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.placebirth')</label>
                                        <input type="text" name="placebirth" class="form-control"
                                            value="{{ isset($id) ? $data->placebirth : old('placebirth') }}" required
                                            placeholder="@lang('doctor.placebirth')" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.birthdate')</label>
                                        <input type="date" name="birthdate" class="form-control"
                                            value="{{ isset($id) ? $data->birthdate : old('birthdate') }}" required
                                            placeholder="@lang('doctor.birthdate')" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.specialist')</label>
                                        <select name="specialist" id="specialist" class="form-control" required>
                                            <option value="">select</option>
                                            @foreach ($specialist as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ isset($id) ? (($data->specialistID == $item->id ? 'selected' : old('specialist') == $item->id) ? 'selected' : '') : '' }}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.academic')</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.degree')</label>
                                        <input type="text" name="degree" placeholder="@lang('doctor.degree')"
                                            class="form-control" value="{{ isset($id) ? $data->degree : old('degree') }}"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.religion')</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.province')</label>
                                        <select name="province" id="province" class="form-control select2-province"
                                            required></select>
                                    </div>
                                    <input type="hidden" name="provinces">
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.district')</label>
                                        <select name="district" id="district" class="form-control select2-district"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.subdistrict')</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.village')</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">@lang('doctor.rt')</label>
                                                <input type="text" name="rt" class="form-control"
                                                    value="{{ isset($id) ? explode('/', $data->rtrw)[0] ?? '' : old('rw') }}"
                                                    required placeholder="@lang('doctor.rt')" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">@lang('doctor.rw')</label>
                                                <input type="text" name="rw" class="form-control"
                                                    value="{{ isset($id) ? explode('/', $data->rtrw)[1] ?? '' : old('rw') }}"
                                                    required placeholder="@lang('doctor.rw')" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.phone')</label>
                                        <input type="text" name="phone" class="form-control"
                                            value="{{ isset($id) ? $data->phone : old('phone') }}" required
                                            placeholder="@lang('doctor.phone')" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.email')</label>
                                        <input type="text" name="email" class="form-control"
                                            value="{{ isset($id) ? $data->email : old('email') }}" required
                                            placeholder="@lang('doctor.email')" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">@lang('doctor.photos')</label>
                                        <input type="file" name="photos" class="form-control"
                                            ...
                                            {{ isset($id) ? '' : 'required' }} placeholder="@lang('doctor.photos')" />
                                    </div>
                                </div>
                            </div>
                            <div>
